...
const Contact = () => {
    return (
        <section id="contact" className="section">
            <div className="container mx-auto px-6 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
                        Contact me for collaboration
                    </h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Feel free to reach out—I’m eager to learn and contribute as a fresher, excited to collaborate on meaningful projects and grow through hands-on experience!
                    </p>
                    <div className="flex items-center gap-4 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a
                                ...
                                className="w-12 h-12 grid place-items-center ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                            >
                                {icon}
                            </a>
                        ))}
                ...
                <form action="https://getform.io/f/broooxna"
                    method="POST"
